...
*/
typedef void (*DDS_OnDataCallBack)(const char *topic, size_t index, void *ptr,
...
@return On success: 0.
        On error: error code is returned.
*/
int dds_add_reader(DDSContext *ctx, const char *topic, DDS_OnDataCallBack func,
                   void *user);
...
@return On success: 0
        On error: error code is returned.
*/
int dds_read(DDSContext *ctx, const char *topic, size_t index, void *buf,
...
@return On success: 0
        On error: error code is returned.
*/
int dds_read_latest(DDSContext *ctx, const char *topic, void *buf, size_t *len,
...
@return On success: 0
        On error: error code is returned.
*/
int dds_get_id_range(DDSContext *ctx, const char *topic, size_t *start,
                     size_t *end);
...
@return On success: 0
        On error: error code is returned.
*/
int dds_read_by_id(DDSContext *ctx, const char *topic, size_t id, void *buf,
...
@return On success: 0
        On error: error code is returned.
*/
int dds_read_by_id_timeout(DDSContext *ctx, const char *topic, size_t id,
                           void *buf, size_t *len, size_t *index,
...
@return On success: 0
        On error: error code is returned.
*/
int dds_read_polling(DDSContext *ctx, const char *topic, size_t *check_id,
                     void *buf, size_t *len, size_t *index,
                     uint64_t timeout_millis, uint64_t sleep_millis);
...
@return On success: 0
        On error: error code is returned.
*/
int dds_read_notify(DDSContext *ctx, const char *topic, void *buf, size_t *len,
                    size_t *id, size_t *index, int32_t timeout_millis);
...
*/
void *dds_ptr_latest_pre_notify(DDSContext *ctx, const char *topic, size_t *id,
...
@return pointer to array[latest_index - 1].
*/
void *dds_ptr_latest_pre(DDSContext *ctx, const char *topic, size_t *id,
                         size_t *index, size_t *size);
...
*/
void *dds_ptr(DDSContext *ctx, const char *topic, size_t index, size_t *id,
              size_t *size);
...
*/
void *dds_ptr_latest(DDSContext *ctx, const char *topic, size_t *id,
                     size_t *index, size_t *size);
...
@param user[in]: user data will be passed to onData.
*/
void dds_register_read_callback(DDSContext *ctx, const char *topic,
                                DDS_OnDataCallBack func, void *user);
