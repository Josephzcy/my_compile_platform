...
typedef enum EventType {
    ...
    EVENT_TYPE_APA_LOCODDSERROR  = 160,                 /*Apa_Location_output_DDS_发送失败*/
    ...
    EVENT_TYPE_APA_AVMPRO3CHNOTCONNER = 170,           /*Apa_Avm_procedure_第3路棋盘格角点检测失败*/
    ...
    EVENT_TYPE_APA_PPIRADARSUBERROR = 180,             /*Apa_Parkingspace_Postprocess_input_无法订阅超声波雷达输入*/
    ...
    EVENT_TYPE_APA_INFERPROCNNERROR = 190,             /*Apa_Inference_procedure_cnn处理错误*/
    ...
    EVENT_TYPE_APA_CONIVEHSubDATAERROR = 200,          /*Apa_Control_input_无法订阅车身数据*/
    ...
    EVENT_TYPE_APA_CONODDSERROR = 210,                 /*Apa_Control_output_发送失败*/
    ...
    EVENT_TYPE_APA_PALNODDSERROR = 220,                 /*Apa_Planning_output_发送失败*/
