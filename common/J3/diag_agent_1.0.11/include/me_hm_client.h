 ...
 */
  ...
  */
  bool RegistAliveTask(const std::uint32_t checkpointId,
                       const std::uint32_t periodMs,
                       const std::uint32_t expectedIndication,
                       const std::uint32_t minMargin,
                       const std::uint32_t maxMargin);
  ...
  */
  bool RegistDeadlineTask(const std::uint32_t srcCheckpointId,
                          const std::uint32_t destCheckpointId,
                          const std::uint32_t deadlineMinMs,
                          const std::uint32_t deadlineMaxMs);
  ...
  */
  bool UnRegistDeadlineTask(const std::uint32_t srcCheckpointId,
                            const std::uint32_t destCheckpointId);
