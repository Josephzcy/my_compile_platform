...
#ifndef COMMON_CONCURRENCY_MUTEX_H
#define COMMON_CONCURRENCY_MUTEX_H
...
#ifdef __ANDROID__
#define PTHREAD_MUTEX_ADAPTIVE_NP PTHREAD_MUTEX_RECURSIVE_NP
...
class MutexBase : public CRITICAL_SECTION
{
...
#endif // COMMON_CONCURRENCY_MUTEX_H
