...
#ifndef COMMON_CONFIG_XML_XML_CONFIGER_HPP
#define COMMON_CONFIG_XML_XML_CONFIGER_HPP
...
public:
    ...
    explicit XMLConfiger(const std::string& strSeparator) { m_strSeparator = strSeparator; }
