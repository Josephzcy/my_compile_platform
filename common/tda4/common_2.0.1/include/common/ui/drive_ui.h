...
private:
    ...
    void DrawSmallCarRect(cv::Mat &mat, const cv::Rect &rect, const cv::Scalar &color = cv::Scalar(32, 250, 253));
...
private:
    ...
    static const cv::Scalar CAR_RECT_COLOR;
    static const cv::Scalar CAR_LINE_COLOR;
    static const cv::Scalar HIT_CAR_RECT_COLOR;
    static const cv::Scalar HIT_CAR_LINE_COLOR;
    static const cv::Scalar HIT_CAR_DIS_CLOSE_COLOR;
    static const cv::Scalar HIT_CAR_DIS_WARN_COLOR;
