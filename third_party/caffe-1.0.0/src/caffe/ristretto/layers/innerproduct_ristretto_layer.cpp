...
template <typename Dtype>
void InnerProductRistrettoLayer<Dtype>::LayerSetUp(const vector<Blob<Dtype>*>& bottom,
...
template <typename Dtype>
void InnerProductRistrettoLayer<Dtype>::Backward_cpu(const vector<Blob<Dtype>*>& top,
...
#ifdef CPU_ONLY
STUB_GPU(InnerProductRistrettoLayer);
#endif
