#ifndef CAFFE_SIGMOID_FOCAL_LOSS_LAYER_HPP_
#define CAFFE_SIGMOID_FOCAL_LOSS_LAYER_HPP_
...
/**
 * @brief Computes the focal loss often used for predicting targets interpreted as probabilities.
 *
 * This layer is implemented rather than separate
 * SigmoidLayer + FocalLossLayer
...
class SigmoidFocalLossLayer : public LossLayer<Dtype> {
 public:
  ...
  virtual inline const char* type() const { return "SigmoidFocalLoss"; }
 ...
 protected:
  ...
  /// the hyper-parameter for calculating focal loss
  Dtype gamma_;
};
