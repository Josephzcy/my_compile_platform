...
def predict_and_benchmark():
    caffenet = init_model(
        "/data/wzheng/projects/caffe-quant-master/examples/car_regression_proj/ristretto/regression_baseline_deploy_quantized.prototxt", \
        "/data/wzheng/projects/caffe-quant-master/examples/car_regression_proj/ristretto/models/box_car_regression_quantized_iter_180000.caffemodel")
