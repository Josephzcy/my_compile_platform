...
#ifndef AIPLORER_FISHEYE_MODEL_H
#define AIPLORER_FISHEYE_MODEL_H
...
namespace minieye {
namespace base {
class FisheyeCameraDistortionModel : public BaseCameraDistortionModel {
public:
  FisheyeCameraDistortionModel() = default;
  ...
  std::string name() const override { return "FisheyeCameraDistortionModel"; }
  ...
  inline const cv::Matx<double, 1, 4> get_distort_params() const {
    return distort_params_;
  }

protected:
  cv::Matx33d intrinsic_params_;
  cv::Matx<double, 1, 4> distort_params_;
};
} // namespace base
} // namespace minieye

#endif // AIPLORER_FISHEYE_MODEL_H
